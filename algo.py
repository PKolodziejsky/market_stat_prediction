...
avg_price = np.asarray(avg_price)

print("Whole dataset length:",len(avg_price))

avg_price = avg_price[-1000000:-800000]

print("Using",len(avg_price),"elements")
